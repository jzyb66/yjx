...
public class PartController {
    ...
    @GetMapping("/list")
    public Result<IPage<Part>> getPartList(@ModelAttribute PartQueryDTO queryModule) {
     ...
     */
    @PostMapping("/addPart")
    public ResponseEntity<Result<Void>> addPart(@RequestBody CreatePartDTO createModule) {
    ...
    public ResponseEntity<Result<Void>> updatePart(@RequestBody UpdatePartDTO updateModule) {
    ...
    public ResponseEntity<Result<Void>> deletePartWithPassword(@RequestBody DeletePartDTO deleteModule) {
